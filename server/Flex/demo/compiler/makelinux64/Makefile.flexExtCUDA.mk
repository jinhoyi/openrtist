...
flexExtCUDA_release_hpaths    += /usr/local/cuda-9.2/include
flexExtCUDA_release_hpaths    += /usr/local/cuda-9.2/extras/cupti/include
flexExtCUDA_release_hpaths    += ./../../..
flexExtCUDA_release_hpaths    += ./../../../external/freeglut/include
flexExtCUDA_release_lpaths    := 
flexExtCUDA_release_lpaths    += /usr/local/cuda-9.2/lib64
...
$(flexExtCUDA_release_cuda_extensions_cuda_flexExt_cu_o): $(flexExtCUDA_cuda_extensions_cuda_flexExt_cu) 
	...
	$(ECHO) /usr/local/cuda-9.2/bin/nvcc -O3 -g -arch=sm_30 -m64 -Xcompiler -fPIC -D_FORCE_INLINES  -I../../.. -I../../../external -I/usr/local/cuda-9.2/include -I../../../external/cub-1.3.2  --compile "./../../../extensions/cuda/flexExt.cu" -o "$(OBJS_DIR)/flexExtCUDA_release/cuda/extensions/cudaflexExt.o"
	/usr/local/cuda-9.2/bin/nvcc -O3 -g -arch=sm_30 -m64 -Xcompiler -fPIC -D_FORCE_INLINES  -I../../.. -I../../../external -I/usr/local/cuda-9.2/include -I../../../external/cub-1.3.2  --compile "./../../../extensions/cuda/flexExt.cu" -o "$(OBJS_DIR)/flexExtCUDA_release/cuda/extensions/cudaflexExt.o"
...
flexExtCUDA_debug_hpaths    += /usr/local/cuda-9.2/include
flexExtCUDA_debug_hpaths    += /usr/local/cuda-9.2/extras/cupti/include
flexExtCUDA_debug_hpaths    += ./../../..
flexExtCUDA_debug_hpaths    += ./../../../external/freeglut/include
flexExtCUDA_debug_lpaths    := 
flexExtCUDA_debug_lpaths    += /usr/local/cuda-9.2/lib64
...
$(flexExtCUDA_debug_cuda_extensions_cuda_flexExt_cu_o): $(flexExtCUDA_cuda_extensions_cuda_flexExt_cu) 
	...
	$(ECHO) /usr/local/cuda-9.2/bin/nvcc -O3 -g -arch=sm_30 -m64 -Xcompiler -fPIC -D_FORCE_INLINES  -I../../.. -I../../../external -I/usr/local/cuda-9.2/include -I../../../external/cub-1.3.2  --compile "./../../../extensions/cuda/flexExt.cu" -o "$(OBJS_DIR)/flexExtCUDA_debug/cuda/extensions/cudaflexExt.o"
	/usr/local/cuda-9.2/bin/nvcc -O3 -g -arch=sm_30 -m64 -Xcompiler -fPIC -D_FORCE_INLINES  -I../../.. -I../../../external -I/usr/local/cuda-9.2/include -I../../../external/cub-1.3.2  --compile "./../../../extensions/cuda/flexExt.cu" -o "$(OBJS_DIR)/flexExtCUDA_debug/cuda/extensions/cudaflexExt.o"
